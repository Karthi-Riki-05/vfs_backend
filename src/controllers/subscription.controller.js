...
class SubscriptionController {
    ...
    createCheckoutSession = asyncHandler(async (req, res) => {
        ...
        const result = await subscriptionService.createCheckoutSession(userId, { plan, teamMembers });
    ...
    changePlan = asyncHandler(async (req, res) => {
        const userId = req.user.id;
        const { plan, teamMembers } = req.body;
        const result = await subscriptionService.changePlan(userId, { plan, teamMembers });
        res.json({ success: true, data: result });
    });
