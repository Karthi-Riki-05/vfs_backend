...
class DashboardController {
    getStats = asyncHandler(async (req, res) => {
        ...
        const stats = await dashboardService.getStats(userId, appContext);
    ...
    getActivity = asyncHandler(async (req, res) => {
        const userId = req.user.id;
        const appContext = req.user.currentVersion || 'free';
        const activity = await dashboardService.getActivity(userId, appContext);
    ...
    getRecentFlows = asyncHandler(async (req, res) => {
        ...
        const flows = await dashboardService.getRecentFlows(userId, appContext, limit);
